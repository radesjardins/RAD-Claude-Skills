...
version: 1.0.0
description: "This skill should be used when the user says \"schedule a recurring meeting\", \"set up a weekly standup\", \"create a repeating event\", \"add a recurring calendar event\", \"set up a regular team sync\", or wants to create a recurring Google Calendar event with a defined recurrence rule and invite attendees."
metadata:
  openclaw:
    category: "recipe"
    domain: "scheduling"
