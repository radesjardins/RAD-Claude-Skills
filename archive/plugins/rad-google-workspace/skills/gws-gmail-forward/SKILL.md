...
version: 1.0.0
description: "This skill should be used when the user says \"forward this email\", \"forward to someone\", \"pass this email along\", \"send this message to\", \"forward with a note\", or wants to forward a specific Gmail message to new recipients. Covers adding a note, CC/BCC, attachments, and HTML content."
metadata:
  openclaw:
