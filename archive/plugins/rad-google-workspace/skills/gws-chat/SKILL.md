...
name: gws-chat
version: 1.0.0
description: "This skill should be used when the user says \"manage Chat spaces\", \"list my Chat rooms\", \"create a Chat space\", \"delete a Chat space\", \"set up a group chat\", \"find a direct message\", or wants to broadly manage Google Chat. Covers spaces, memberships, messages, custom emojis, and media uploads."
metadata:
  openclaw:
