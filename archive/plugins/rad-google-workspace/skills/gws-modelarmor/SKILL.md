...
name: gws-modelarmor
version: 1.0.0
description: "This skill should be used when the user says \"filter content for safety\", \"set up Model Armor\", \"sanitize AI input\", \"screen prompts for harmful content\", \"manage safety templates\", or wants to broadly work with Google Model Armor. Covers creating templates and sanitizing prompts and model responses."
metadata:
  openclaw:
