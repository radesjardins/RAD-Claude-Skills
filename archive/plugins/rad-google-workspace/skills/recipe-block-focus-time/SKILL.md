...
version: 1.0.0
description: "This skill should be used when the user says \"block focus time\", \"protect my mornings\", \"add deep work blocks\", \"block off my calendar\", \"reserve time for focused work\", or wants to create recurring focus time events on Google Calendar to protect deep work hours."
metadata:
  openclaw:
    category: "recipe"
    domain: "scheduling"
