...
version: 1.0.0
description: "This skill should be used when the user says \"event coordinator mode\", \"help me plan an event\", \"send out invitations\", \"set up the event calendar\", \"track RSVPs\", \"manage event logistics\", or \"announce the event\", or wants to coordinate event scheduling, invitations, materials, and attendee tracking across Workspace."
metadata:
  openclaw:
    category: "persona"
    requires:
