...
version: 1.0.0
description: "This skill should be used when the user says \"generate a report from my sheet\", \"turn spreadsheet data into a doc\", \"create a report from Google Sheets\", \"write up a summary doc from my data\", \"build a report document from sheet data\", or wants to read data from Google Sheets and produce a formatted report in Google Docs, shared via Drive."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
