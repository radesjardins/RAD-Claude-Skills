...
name: gws-forms
version: 1.0.0
description: "This skill should be used when the user says \"create a Google Form\", \"read form responses\", \"update a form\", \"get form submissions\", \"set up a survey\", \"publish a form\", or wants to work with Google Forms. Covers creating, reading, updating forms and retrieving responses."
metadata:
  openclaw:
