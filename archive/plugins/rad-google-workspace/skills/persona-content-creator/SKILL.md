...
version: 1.0.0
description: "This skill should be used when the user says \"content creator mode\", \"help me draft content\", \"organize my content assets\", \"share my article\", \"upload media to Drive\", \"send for content review\", or \"manage my content calendar\", or wants to draft, organize, and distribute content using Google Docs, Drive, Gmail, and Chat."
metadata:
  openclaw:
    category: "persona"
    requires:
