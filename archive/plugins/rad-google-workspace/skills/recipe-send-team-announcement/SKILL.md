...
version: 1.0.0
description: "This skill should be used when the user says \"send a team announcement\", \"announce something to the team\", \"blast out a message to everyone\", \"notify the team by email and chat\", \"post an update in Gmail and Chat\", or wants to send a team announcement simultaneously via Gmail and a Google Chat space."
metadata:
  openclaw:
    category: "recipe"
