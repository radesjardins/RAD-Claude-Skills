...
version: 1.0.0
description: "This skill should be used when the user says \"plan my week\", \"set up my weekly schedule\", \"review my calendar for the week\", \"fill in my weekly calendar\", \"organize my week in Google Calendar\", or wants to review the current week in Google Calendar, identify open slots, and add events to fill them."
metadata:
  openclaw:
    category: "recipe"
    domain: "scheduling"
