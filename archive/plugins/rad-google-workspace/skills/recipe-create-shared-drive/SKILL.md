...
version: 1.0.0
description: "This skill should be used when the user says \"create a shared drive\", \"set up a team drive\", \"make a shared folder for the team\", \"create a Google Drive for my project\", \"add people to a shared drive\", or wants to create a Google Shared Drive and add members with appropriate editor or viewer roles."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
