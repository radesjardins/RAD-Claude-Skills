...
name: gws-tasks
version: 1.0.0
description: "This skill should be used when the user says \"manage my tasks\", \"add a task\", \"list my to-dos\", \"create a task list\", \"mark a task complete\", \"show my open tasks\", or wants to manage Google Tasks. Covers task lists, individual tasks, subtasks, reordering, and clearing completed tasks."
metadata:
  openclaw:
