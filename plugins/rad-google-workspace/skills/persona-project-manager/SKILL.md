...
version: 1.0.0
description: "This skill should be used when the user says \"project manager mode\", \"track project status\", \"schedule a team standup\", \"share project docs\", \"send a stakeholder update\", \"PM help\", or \"log a project update\", or wants to coordinate projects by tracking tasks, scheduling meetings, and sharing artifacts across Workspace."
metadata:
  openclaw:
    category: "persona"
    requires:
