...
version: 1.0.0
description: "This skill should be used when the user says \"download all files from a folder\", \"bulk download from Drive\", \"get everything in that folder\", \"export Drive folder contents\", \"download my Drive files locally\", or wants to list and download all files from a Google Drive folder."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
