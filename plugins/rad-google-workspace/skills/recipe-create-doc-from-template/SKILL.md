...
version: 1.0.0
description: "This skill should be used when the user says \"create a doc from a template\", \"make a copy of my template\", \"use my doc template\", \"generate a document from a template\", \"duplicate my Google Doc template\", or wants to copy a Google Docs template, fill it with content via Drive, and share it with collaborators."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
