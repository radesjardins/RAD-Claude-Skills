...
name: gws-gmail-send
version: 1.0.0
description: "This skill should be used when the user says \"send an email\", \"email someone\", \"compose a message\", \"write an email to\", \"send a Gmail\", \"draft and send\", or wants to send a new outbound email through Gmail. Covers recipients, subject, body, CC/BCC, attachments, HTML content, and send-as aliases."
metadata:
  openclaw:
