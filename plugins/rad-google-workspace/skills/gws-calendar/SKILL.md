...
name: gws-calendar
version: 1.0.0
description: "This skill should be used when the user says \"manage my calendar\", \"list my calendars\", \"update calendar settings\", \"share a calendar\", \"delete a calendar\", \"check free/busy time\", or wants to broadly manage Google Calendar. Covers calendars, events, ACL rules, free/busy queries, and settings."
metadata:
  openclaw:
