...
version: 1.0.0
description: "This skill should be used when the user says \"what's on my calendar\", \"show my schedule\", \"what do I have today\", \"show this week's events\", \"what's coming up\", \"show my agenda\", or wants to view upcoming events across calendars. Covers listing today, tomorrow, this week, or N days ahead, with optional calendar filtering."
metadata:
  openclaw:
