...
version: 1.0.0
description: "This skill should be used when the user says \"label and archive my emails\", \"clean up my inbox\", \"organize and archive Gmail messages\", \"tag emails and move them out of inbox\", \"bulk label my messages\", or wants to apply Gmail labels to matching messages and archive them to keep the inbox clean."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
