...
version: 1.0.0
description: "This skill should be used when the user says \"reply to this email\", \"send a reply\", \"respond to that message\", \"write back to sender\", \"reply to the sender only\", or wants to send a threaded reply to a single Gmail message. Covers in-reply-to threading, attachments, CC/BCC, and HTML replies."
metadata:
  openclaw:
