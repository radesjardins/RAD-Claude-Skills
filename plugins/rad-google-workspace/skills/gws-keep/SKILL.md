...
name: gws-keep
version: 1.0.0
description: "This skill should be used when the user says \"create a Keep note\", \"add a note\", \"list my notes\", \"delete a note\", \"read a Google Keep note\", \"show my Keep notes\", or wants to manage Google Keep. Covers creating, reading, listing, and deleting notes and their attachments."
metadata:
  openclaw:
