...
version: 1.0.0
description: "This skill should be used when the user says \"save my email attachments\", \"download attachments to Drive\", \"extract attachments from Gmail\", \"backup email files\", \"move attachments to folder\", or wants to find Gmail messages with attachments and save them to a Google Drive folder."
metadata:
  openclaw:
    category: "recipe"
    domain: "productivity"
