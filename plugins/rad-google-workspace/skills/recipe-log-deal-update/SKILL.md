...
version: 1.0.0
description: "This skill should be used when the user says \"log a deal update\", \"update my sales pipeline\", \"add a deal to the tracking sheet\", \"record a new deal status\", \"append to the sales spreadsheet\", or wants to append a deal status update row to a Google Sheets sales tracking spreadsheet, located via Google Drive."
metadata:
  openclaw:
    category: "recipe"
    domain: "sales"
