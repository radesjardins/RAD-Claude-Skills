...
name: gws-people
version: 1.0.0
description: "This skill should be used when the user says \"manage my contacts\", \"look up a contact\", \"add a new contact\", \"search my address book\", \"list contact groups\", \"update someone's contact info\", or wants to manage Google People/Contacts. Covers personal contacts, contact groups, directory search, and profile photos."
metadata:
  openclaw:
