...
name: gws-workflow
version: 1.0.0
description: "This skill should be used when the user says \"run a workflow\", \"automate across Google services\", \"combine calendar and tasks\", \"do a multi-step Workspace task\", \"cross-service automation\", or wants to broadly access Google Workspace cross-service workflows. Covers standup reports, meeting prep, email-to-task, weekly digests, and file announcements."
metadata:
  openclaw:
