...
name: gws-docs
version: 1.0.0
description: "This skill should be used when the user says \"read a Google Doc\", \"create a document\", \"get the contents of a doc\", \"update a document\", \"make a new Google Doc\", \"batch update a doc\", or wants to broadly work with Google Docs. Covers creating, reading, and batch-updating document content."
metadata:
  openclaw:
