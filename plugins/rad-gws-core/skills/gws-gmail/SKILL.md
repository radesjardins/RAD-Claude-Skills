...
name: gws-gmail
version: 1.0.0
description: "This skill should be used when the user says \"manage my Gmail\", \"work with email\", \"set up email filters\", \"manage labels\", \"check my Gmail profile\", \"manage email settings\", or wants to broadly manage Gmail. Covers messages, threads, labels, drafts, filters, and push notification settings."
metadata:
  openclaw:
