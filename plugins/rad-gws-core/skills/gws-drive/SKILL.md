...
name: gws-drive
version: 1.0.0
description: "This skill should be used when the user says \"manage my Drive files\", \"search Google Drive\", \"list files in a folder\", \"share a file\", \"create a shared drive\", \"download a file from Drive\", or wants to broadly manage Google Drive. Covers files, folders, permissions, comments, shared drives, and revisions."
metadata:
  openclaw:
