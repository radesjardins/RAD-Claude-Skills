...
name: gws-gmail-read
version: 1.0.0
description: "This skill should be used when the user says \"read this email\", \"show me the body of a message\", \"get the contents of an email\", \"what does this message say\", \"show headers for this email\", or wants to read a specific Gmail message by ID. Covers plain text body, HTML body, and message headers."
metadata:
  openclaw:
