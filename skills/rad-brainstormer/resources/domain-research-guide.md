...
This reference guides domain research for quickly becoming informed enough to be a useful brainstorming partner in any domain. It covers what to research, how deep to go, and how to present findings.

---

## Why Domain Research Matters

Innovation Growth Lab research demonstrates that domain experts combined with diverse information tools produce 11% more creative solutions spanning 5 distinct clusters, compared to experts working without such tools. The mechanism is straightforward: broader information inputs create more combinatorial possibilities for novel ideas.
...
Domain research should produce a structured brief that can be quickly scanned and referenced during the brainstorming session.
